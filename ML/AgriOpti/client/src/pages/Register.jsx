...
const Register = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-mesh p-6 relative overflow-hidden">
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-nature-200/20 blur-[120px] rounded-full"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-nature-300/20 blur-[120px] rounded-full"></div>

      <div className="w-full max-w-md relative z-10 transition-all duration-500">
        <div className="flex justify-center mb-8">
          <div className="bg-nature-600 p-4 rounded-3xl shadow-lg -rotate-3 hover:rotate-0 transition-all duration-500 cursor-pointer group">
        ...
        <div className="glass rounded-[2.5rem] p-6 md:p-12 shadow-2xl border-white/50 backdrop-blur-xl">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-widest text-nature-700 ml-1">{t('full_name')}</label>
              <input
                type="text"
                name="name"
                ...
                className={`input-field focus:ring-2 focus:ring-nature-500 outline-none transition-all ${errors.name ? 'border-red-400' : ''}`}
                required
              />
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-widest text-nature-700 ml-1">Your Role</label>
