    ...
    return (
        <div className="min-h-screen flex flex-col bg-nature-50/30 relative">
            ...
            <main className="flex-grow pt-[88px]">
                {/* Header Section */}
                <div className="bg-nature-950 text-white relative py-20 px-6 overflow-hidden">
                    <div className="absolute inset-0 bg-mesh opacity-20" />
                    <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center text-center space-y-6">
                        <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-nature-600/20 border border-nature-600/30 text-nature-400 text-xs font-black uppercase tracking-[0.3em]">
                            <FaShoppingBag /> Orders Management
                        </div>
                        <div className="space-y-2">
                            <h1 className="text-4xl md:text-6xl font-heading font-black tracking-tight leading-tight uppercase">
                                Your <span className="text-nature-400">Purchases</span>
                            </h1>
                            <p className="text-nature-300 text-lg md:text-xl font-medium max-w-2xl mx-auto">
                                {pageSubtitle}
                            </p>
                        </div>
                    </div>
