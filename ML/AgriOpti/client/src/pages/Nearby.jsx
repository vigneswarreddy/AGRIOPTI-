  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAF9]">
      ...
      <main className="flex-grow flex flex-col pt-[88px]">
        ...
        <div className="bg-nature-950 text-white relative py-12 px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="space-y-4 text-center md:text-left">
              <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-nature-600/20 border border-nature-600/30 text-nature-400 text-[10px] font-black uppercase tracking-[0.3em]">
              ...
              <h1 className="text-4xl md:text-5xl font-heading font-black tracking-tighter uppercase leading-none">
                Nearby <span className="text-nature-400">Services</span>
              </h1>
            </div>

            <div className="w-full md:w-1/3 mt-6 md:mt-0">
              <form onSubmit={handleLocationSearch} className="relative w-full max-w-sm ml-auto">
                <input
                  type="text"
                  placeholder="Enter city, town, or zip code..."
                  className="w-full pl-5 pr-14 py-4 rounded-2xl bg-white/10 border border-white/20 text-white placeholder-nature-300 focus:outline-none focus:ring-2 focus:ring-nature-400 focus:bg-white/20 backdrop-blur-md transition-all text-sm font-medium"
                  value={searchQuery}
                ...
                <button
                  type="submit"
                  disabled={isSearchingLocation}
                  className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-nature-400 text-nature-950 rounded-xl flex items-center justify-center hover:bg-nature-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
                >
            ...
            <div className="hidden md:flex gap-4">
              <div className="px-6 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
                <p className="text-[10px] font-black text-nature-500 uppercase tracking-widest leading-none mb-1">Status</p>
                <p className="text-sm font-black flex items-center gap-2 text-nature-300">
                  <span className={`w-2 h-2 rounded-full ${showMap ? 'bg-nature-400 animate-pulse' : 'bg-red-400'}`}></span>
