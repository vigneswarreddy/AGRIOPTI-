    ...
    <div className="min-h-screen flex flex-col bg-nature-50/30">
      ...
      <div className="flex-1 pt-24 md:pt-32">
        <main className="flex-1 overflow-y-auto">
          ...
          {/* Dashboard Header */}
          <div className="bg-nature-950 text-white relative py-10 md:py-16 px-6 md:px-10 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-3 px-4 py-1 rounded-full bg-nature-600/20 border border-nature-600/30 text-nature-400 text-[10px] font-black uppercase tracking-[0.3em]">
                  <FaLeaf /> {hdr.tag}
                </div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-black tracking-tight leading-none uppercase break-words w-full">
                  Welcome, <span className="text-nature-400">{user.username}</span>
                </h1>
                <p className="text-nature-400 text-xs font-bold uppercase tracking-widest ml-1">{hdr.subtitle}</p>
              </div>
              {/* Role Badge */}
              <div className={`px-5 py-2 rounded-2xl text-white text-sm font-black uppercase tracking-widest ${roleConf.badge}`}>
                {roleConf.label}
              </div>
            </div>
          </div>
