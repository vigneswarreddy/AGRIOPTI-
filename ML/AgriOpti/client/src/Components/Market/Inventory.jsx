                        ...
                        <div className="flex gap-4 mt-6">
                            ...
                            <button
                                onClick={async () => {
                                    ...
                                    const seedData = [
                                        { productType: 'crops', name: 'Premium Wheat Seeds', desc: 'High yield drought resistant wheat seeds.', price: 1200, stock: 50, rating: 5, image: 'https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?q=80&w=800' },
                                        { productType: 'crops', name: 'Golden Corn Seeds', desc: 'Fast growing sweet corn seeds.', price: 800, stock: 30, rating: 4, image: 'https://images.unsplash.com/photo-1588661642878-8314ba6eccc7?q=80&w=800' },
                                        { productType: 'crops', name: 'Basmati Rice Seeds', desc: 'Aromatic long grain rice seeds.', price: 2000, stock: 100, rating: 5, image: 'https://images.unsplash.com/photo-1590059388147-384be851c86e?q=80&w=800' },
                                        { productType: 'crops', name: 'Cotton Seeds', desc: 'BT Cotton seeds for maximum yield.', price: 2500, stock: 20, rating: 5, image: '/products/cotton_seeds.png' },
                                        { productType: 'pesticides', name: 'Organic Neem Oil', desc: 'Natural pest repellent and fungicide.', price: 450, stock: 60, rating: 5, image: 'https://images.unsplash.com/photo-1605553597818-fdb16eebd5bd?q=80&w=800' },
                                        { productType: 'pesticides', name: 'Bio-Fungicide', desc: 'Effectively controls root rot and wilt.', price: 600, stock: 25, rating: 4, image: 'https://images.unsplash.com/photo-1629858712793-176840d0ea3d?q=80&w=800' },
                                        { productType: 'pesticides', name: 'Insect Destroyer Pro', desc: 'Broad spectrum systemic insecticide.', price: 850, stock: 15, rating: 4, image: '/products/insecticide.png' },
                                        { productType: 'pesticides', name: 'Herbal Weedicide', desc: 'Selective organic weed control.', price: 500, stock: 45, rating: 5, image: '/products/weedicide.png' },
                                        { productType: 'pesticides', name: 'NPK Fertilizer blend', desc: '19:19:19 water soluble fertilizer.', price: 1200, stock: 100, rating: 5, image: 'https://images.unsplash.com/photo-1625807981504-f5bcadaabecc?q=80&w=800' },
                                        { productType: 'machinery', name: 'Heavy Duty Tractor', desc: '50 HP Tractor for all farming operations.', price: 650000, stock: 2, rating: 5, image: 'https://images.unsplash.com/photo-1601633519890-ffb86121beed?q=80&w=800' },
                                        { productType: 'machinery', name: 'Rotavator Plus', desc: '7 feet rotavator for soil preparation.', price: 120000, stock: 5, rating: 4, image: '/products/rotavator.png' },
                                        { productType: 'machinery', name: 'Knapsack Sprayer', desc: '16L Battery operated pesticide sprayer.', price: 3500, stock: 20, rating: 5, image: 'https://images.unsplash.com/photo-1523301343968-6a6ebf63c672?q=80&w=800' },
                                        { productType: 'machinery', name: 'Harvester Machine', desc: 'Combine harvester for large fields.', price: 1500000, stock: 1, rating: 5, image: 'https://images.unsplash.com/photo-1563514227147-6d2ff665a6a0?q=80&w=800' },
                                        { productType: 'machinery', name: 'Water Pump Set', desc: '5 HP submersible water pump.', price: 25000, stock: 8, rating: 4, image: 'https://images.unsplash.com/photo-1518047970725-3b9e4a317e07?q=80&w=800' }
                                    ];
                                    for(let item of seedData) {
                                        await addDoc(collection(db, "products"), { ...item, createdBy: user._id, createdAt: serverTimestamp() });
                                    }
                                    alert("Database successfully seeded 🎉! You will now see products on the Market page and Dashboard.");
                                }}
                                className="px-6 border-2 border-nature-200 text-nature-600 font-bold rounded-[0.875rem] hover:bg-nature-50 transition-colors"
                            >
                                Auto-Seed Database 🚀
                            </button>
                        </div>
