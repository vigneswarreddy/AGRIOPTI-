  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        console.error("Error fetching pesticides from Firebase:", error);
      }
    };
    fetchProducts();
  }, []);
          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="space-y-2">
              <h1 className="text-4xl md:text-6xl font-heading font-black text-nature-950 tracking-tight leading-none">
                Pesticides & <span className="text-nature-600 italic">Fertilizers</span>
              </h1>
              <p className="text-nature-500 font-medium text-lg max-w-2xl">
                Scientific solutions for crop protection and soil enrichment. Boost your yield with our curated selection of verified products.
              </p>
            </div>
          </div>
        </div>
