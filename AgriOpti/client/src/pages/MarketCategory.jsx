    ...
    <div className="min-h-screen flex flex-col bg-nature-50/30">
      ...
      <div className="flex-1 pt-24 md:pt-32">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 md:px-8 mb-8 relative z-10">
          ...
          <div className="bg-nature-950/95 backdrop-blur-3xl rounded-[3rem] border border-white/10 shadow-2xl overflow-hidden relative py-12 px-8 md:px-12 flex flex-col items-start">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/10 to-transparent"></div>
            
            <div className="relative z-10">
              <button 
                onClick={() => navigate('/market')}
                className="flex items-center gap-2 text-emerald-400 hover:text-white transition-colors mb-6 text-sm font-black uppercase tracking-widest"
              >
                <FaChevronLeft /> Back to Marketplace
              </button>
              <h1 className="text-4xl md:text-5xl font-heading font-black capitalize tracking-tight text-white">
                {category} <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">Market</span>
              </h1>
