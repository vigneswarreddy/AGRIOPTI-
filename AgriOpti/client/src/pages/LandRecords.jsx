                    ...
                    <div className="bg-nature-950/95 backdrop-blur-3xl rounded-[3rem] border border-white/10 shadow-2xl overflow-hidden relative py-12 px-8 md:px-12 flex flex-col items-center text-center">
                        ...
                        <div className="relative z-10 space-y-4 max-w-4xl mx-auto">
                            <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-emerald-600/20 border border-emerald-600/30 text-emerald-400 text-[10px] font-black uppercase tracking-[0.2em] shadow-sm">
                                <FaShieldAlt /> {tr.heroTag}
                            </div>
                            <h1 className="text-4xl md:text-5xl font-heading font-black tracking-tight leading-none uppercase text-white">
                                {tr.heroTitle[0]} <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">{tr.heroTitle[1]}</span>
                            </h1>
                            <p className="text-nature-400 text-sm font-bold leading-relaxed">
                                {tr.heroSubtitle}
                            </p>
                            ...
                            <div className="flex flex-wrap justify-center gap-4 pt-4">
                                <button
                                    ...
                                    className="px-6 py-3 bg-white/10 border border-white/20 rounded-2xl flex items-center gap-3 hover:bg-white/20 transition-all text-sm font-black uppercase tracking-widest text-white shadow-sm"
                                >
                                    <FaInfoCircle /> {tr.recordTypesBtn}
                                </button>
                                <button
                                    onClick={() => setLanguage(language === 'English' ? 'Hindi' : 'English')}
                                    className="px-6 py-3 bg-emerald-500 text-nature-950 rounded-2xl flex items-center gap-3 hover:bg-emerald-400 transition-all text-sm font-black uppercase tracking-widest shadow-xl shadow-emerald-500/20"
                                >
