    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-nature-50/30 p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 transition-all duration-500">
        <div className="flex justify-center mb-8">
          <div className="bg-nature-950 p-4 rounded-3xl shadow-2xl rotate-3 hover:rotate-6 transition-all duration-500 group cursor-pointer border border-nature-800">
        ...
        <div className="bg-white/90 backdrop-blur-3xl rounded-[3rem] p-8 md:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-nature-100">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-black uppercase tracking-widest text-nature-500 ml-1">{t('role')}</label>
