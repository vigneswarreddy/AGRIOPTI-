          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="space-y-2">
              <h1 className="text-4xl md:text-6xl font-heading font-black text-nature-950 tracking-tight leading-none">
                Tools & <span className="text-nature-600 italic">Machinery</span>
              </h1>
              <p className="text-nature-500 font-medium text-lg max-w-2xl">
                State-of-the-art agricultural equipment to automate and elevate your farming operations. Durable, high-performance, and verified.
              </p>
            </div>
          </div>
        </div>
