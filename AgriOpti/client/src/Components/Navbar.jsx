...
import { FaUserCircle, FaBars, FaTimes, FaLeaf, FaMicrochip, FaChartLine, FaStore, FaSeedling, FaRobot, FaSatellite, FaFlask, FaDownload } from 'react-icons/fa'
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden fixed inset-0 top-[80px] z-40 bg-nature-50/95 backdrop-blur-3xl overflow-y-auto pb-20 custom-scrollbar"
          >
            <div className="flex flex-col p-6 space-y-10">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {navLinks.map((link, i) => (
                    ...
                    >
                      <Link
                        to={link.path}
                        className="p-5 rounded-3xl bg-white border border-nature-100 shadow-sm flex flex-col gap-2 hover:border-nature-300 transition-colors"
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {showInstallBtn && (
                    <button
                      className="w-full p-6 rounded-[2.5rem] bg-nature-950 text-white shadow-xl flex justify-between items-center"
                  ...
                  {allFeatureLinks.map((link, i) => (
                    ...
                    >
                      <Link
                        to={link.path}
                        className="p-6 rounded-[2.5rem] bg-white border border-nature-100 shadow-sm flex justify-between items-center hover:border-nature-300 transition-colors"
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        <div className="flex flex-col">
